---
memory_id: 9c2ef322-8f3d-4a54-ba05-7ae4dc21d6ef
hash: 01386ae83e0429686d52874432be577a
last_indexed: '2026-07-07T11:07:43.516241'
---
...
- [[Docs/Specification.md|Техническая спецификация]]: Схема БД, канонизация параметров и стандарты СИ.
- [[Docs/Project_Structure.md|Устройство проекта]]: Детальное описание файлов, Vite и архитектуры.
- [[Docs/Roadmap.md|План развития]]: Достигнутые вехи и будущие цели.
- `import_obsidian.py` (скрипт импорта): Полная логика парсера и ETL.
- `models.py` (схема базы данных): Схема базы данных SQLModel.
...
- **[[Docs/Specification.md|Стандарты измерений]]**: Все внутренние расчеты ведутся строго в единицах СИ.

---

## 🔗 Связанные разделы
- [[Docs/Specification.md|Техническая спецификация]]: Глубокое погружение в архитектуру.
- [[Docs/Roadmap.md|План развития]]: Будущее проекта.
- [База знаний датчиков](../../10_Работа/Оборудование/Датчики/GlobalTest/Notes): Исходные данные для импорта.
- [[../../00_Система/Оглавление.md|🧭 Навигация]]: Вернуться в главное меню.
