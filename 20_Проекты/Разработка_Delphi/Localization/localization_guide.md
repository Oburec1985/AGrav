---
memory_id: 610040a1-93e8-4e81-8c61-511572703a1a
hash: ed38a22d311f45f0e1cbdea60336162e
last_indexed: '2026-07-07T09:42:00.109947'
---
...
pause
```
[[Локализация.md|Методология локализации]].

> [!TIP]
> Эти скрипты теперь интегрированы в **Системные Инструменты AGrav**:
> [Локализация dxgettext](../../../00_Система/Инструменты/Локализация_dxgettext.md)
